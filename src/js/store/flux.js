...
const getState = ({ getStore, getActions, setStore }) => { // setStore updates the store
    return {
        ...
        actions: {
            createUser: () => {
                fetch("https://playground.4geeks.com/contact/agendas/carolinab", {
                    method: "POST",
            ...
            getInfoContacts: () => {
                fetch("https://playground.4geeks.com/contact/agendas/carolinab/contacts", {
                    method: "GET"
                })
                    .then((response) => {
            ...
            deleteContact: (id) => {
                fetch(`https://playground.4geeks.com/contact/agendas/carolinab/contacts/${id}`, {
                    method: "DELETE",
                })
                    .then((response) => {
